...
#version check qt
!minQtVersion(5, 6, 2) {
    message("Cannot build QML Creator with Qt version $${QT_VERSION}.")
...
macx {
    ...
    dmg.commands = python -u \"$$PWD/scripts/makedmg.py\" \"$${BASENAME}.dmg\" \"QML Creator\" \"$$IDE_SOURCE_TREE\" \"$$OUT_PWD/bin\"
